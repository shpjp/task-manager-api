...
export function EmptyState({
  ...
  return (
    <div className="flex flex-col items-center gap-2 rounded-xl border border-dashed border-slate-300 bg-white px-6 py-14 text-center dark:border-neutral-800 dark:bg-neutral-950">
